import NoSummary from "@/components/summaries/no-summary";
          ...
          <div className="flex gap-4 mb-8 justify-between">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-gray-600">
                Transform you PDFs into concise, actionable insights
              </p>
            </div>
            {!hasReachedLimit && (
              <Button
          ...
          {hasReachedLimit && (
            <div className="mb-6">
              <div className="bg-rose-50 border border-rose-200 rounded-lg p-4 text-rose-800">
                <p className="text-sm">
                  You've reached the limit of uploads on the Basic Plan.
                  <Link
                    href={"/#pricing"}
